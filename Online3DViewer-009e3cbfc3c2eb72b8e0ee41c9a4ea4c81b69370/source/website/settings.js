...
export class Settings
{
    constructor (themeId)
    {
        ...
        this.edgeSettings = new EdgeSettings (true, new RGBColor (0, 0, 0), 50);
    }
    ...
    LoadFromCookies ()
    {
        ...
        this.edgeSettings.showEdges = true;//CookieGetBoolVal ('ov_show_edges', false);
        this.edgeSettings.edgeColor = new RGBColor (0, 0, 0);//CookieGetRGBColorVal ('ov_edge_color', new RGBColor (0, 0, 0));
        this.edgeSettings.edgeThreshold = 50;//CookieGetIntVal ('ov_edge_threshold', 1);
    }
...
export class CameraSettings
{
    constructor ()
    {
        this.navigationMode = NavigationMode.FreeOrbit;
        this.projectionMode = ProjectionMode.Orthographic;
    }

    LoadFromCookies ()
    {
        this.navigationMode = CookieGetIntVal ('ov_navigation_mode', NavigationMode.FreeOrbit);
        this.projectionMode = CookieGetIntVal ('ov_projection_mode', ProjectionMode.Orthographic);
    }
